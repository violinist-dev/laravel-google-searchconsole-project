...
@section('content')
    ...
    <div class="col-sm-12">
        ...
        <div class="border-bottom mb-3">
            <h2>{{ $site->title }} {{ $site->url }}
                <a class="btn btn-outline-primary" href="{{ route('sites.edit', $site->id) }}" role="button">設定</a>
            </h2>
        </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="now" role="tabpanel">
                <div class="card mb-2">
                    <div class="card-block p-2">
                        ...
                        {{ Form::open(['route' => ['sites.show', $site->id], 'method' => 'post', 'class' => 'form-inline']) }}
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::button('csvでダウンロード', ['type' => 'submit', 'class' => 'btn btn-primary m-1', 'name' => 'action', 'value' => 'csv']) }}
                        </div>
            ...
            <div class="tab-pane" id="past" role="tabpanel">
                @include('sites.past', ['route_memo' => 'sites.memo'])
